        ...
        <div className="process-container">
          <div className="process-content">
            <div className="process-left">
              <img src="/src/assets/images/dlivery-img.jpg" alt="Delivery Process" className="process-image" />
            </div>
            ...
            <div className="process-right">
              ...
              <div className="process-cta">
                <button className="shop-now-btn" aria-label="Shop now">Shop Now</button>
              </div>
            </div>
          </div>
        </div>
