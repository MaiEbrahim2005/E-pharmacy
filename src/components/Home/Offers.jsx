          ...
          <div className="offers-grid">
            <article className="offer-card" aria-label="Vitamins & Supplements Offer">
              <div className="offer-image">
                <img src="/src/assets/images/promotion-banner1.jpg" alt="Vitamins and supplements" />
              </div>
            ...
            <article className="offer-card" aria-label="Baby & Childcare Offer">
              <div className="offer-image">
                <img src="/src/assets/images/promotion-banner2.jpg" alt="Baby and childcare" />
              </div>
              <div className="offer-content">
                <div className="offer-percentage">
            ...
            <article className="offer-card" aria-label="Personal care & Wellness Offer">
              <div className="offer-image">
                <img src="/src/assets/images/promotion-banner3.jpg" alt="Personal care and wellness" />
              </div>
              <div className="offer-content">
                <div className="offer-percentage">
